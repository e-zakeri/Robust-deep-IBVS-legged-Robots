...
class ANImageViewerNode(Node):
    def __init__(self):
        super().__init__("R1_go2_visualization_T0_F_node")
        ...
        self.log_path = os.path.join(log_dir, "Test0_ALoFTR_F.csv")
        ...
        # ✅ Subscribe to features: [s_d(6), s(6)]
        # Change topic if yours is different.
    ...
    def features_cb(self, msg: Float32MultiArray):
        """
        msg.data is expected to be 12 floats:
          [s_d0..s_d5, s0..s5]
